...
$rows = [];
$rows[] = ['Report ID','Business','Branch','Date','Shift','Total Sales','Expenses','EWallet','Discounts','Expected Cash','Actual Cash','Discrepancy'];
...
xlsx_send('sales_summary.xlsx', $rows);
